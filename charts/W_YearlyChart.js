  ...
  return (
    <ScrollView horizontal showsHorizontalScrollIndicator={true}>
      <View>
        <BarChart
          data={chartData}
          width={chartWidth} // Use the updated width for scrolling
          height={280}
          yAxisLabel=""
          yAxisSuffix=" واط" // Updated to "W" to indicate watts
          chartConfig={{
            backgroundColor: '#f2f2f2',
            backgroundGradientFrom: '#f2f2f2',
            backgroundGradientTo: '#f2f2f2',
            decimalPlaces: 0, // Adjusted for whole numbers since dealing with larger watt values
