...
# Run this in terminal: python api.py
# http://127.0.0.1:5000/api/getRecentUsage

from flask import Flask, jsonify
import pyemvue
from pyemvue.enums import Scale, Unit
import os
from config import EMVUE_EMAIL, EMVUE_PASSWORD  # Importing sensitive information from config.py

app = Flask(__name__)

def fetch_energy_usage():
    vue = pyemvue.PyEmVue()
    vue.login(username=EMVUE_EMAIL, password=EMVUE_PASSWORD)  # Using sensitive information from config.py
